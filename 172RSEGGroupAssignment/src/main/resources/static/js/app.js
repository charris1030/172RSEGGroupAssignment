 	   ...
 	   $http({
 	   	...
 	   	console.log(curr);
 	   	 ...
 	   	 curr.forEach(function(value){
 			 ...
 			 var timestamp = moment.utc(parseInt(value.lastModified)).zone(5).format('MM/DD/YYYY h:mm A');
 			  $scope.ListofFiles.push({FileName:f, Fullpath: fullpath, Timestamp: timestamp});
  		   });
